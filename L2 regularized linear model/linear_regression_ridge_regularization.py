# -*- coding: utf-8 -*-
"""linear_regression_Ridge_regularization.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1fQt9lRqcO2FgsJL3dKaS_ZRtfsbxKl4Q
"""
...
def mse(N,Y,Y_hat,m):#the MSE function for error computation
  return (2/N)*sum(Y-Y_hat)**2 - (1.5*sum(m)**2)
